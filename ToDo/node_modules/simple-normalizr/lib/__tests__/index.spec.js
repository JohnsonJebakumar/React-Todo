...
var categoriesOutput = {
  entities: {
    categories: {
      ...
      '12878000000083109': {
        ...
        permalink: 'general-1',
        articleviewtype: 'LISTVIEW',
        child: ['12878000000572018', '12878000000284627', '12878000000284624', '12878000000706012', '12878000000706027'],
        departmentId: '12878000000006907'
      },
      '12878000000710004': {
        level: '2',
      ...
      '12878000000083106': {
        ...
        permalink: 'reactimpl',
        articleviewtype: 'LISTVIEW',
        child: ['12878000000706018', '12878000000706024', '12878000000083109', '12878000000710004', '12878000000708099', '12878000000706021', '12878000000284630', '12878000000706001'],
        departmentId: '12878000000006907'
      },
      '12878000000158018': {
        level: '1',
        ...
        permalink: 'react1sdfddsfds',
        articleviewtype: 'OVERVIEW',
        child: ['12878000000252145', '12878000000158021', '12878000000708076', '12878000000708070', '12878000000708067', '12878000000708123', '12878000000708046', '12878000000708049'],
        departmentId: '12878000000091980'
      },
      '12878000000173083': {
        level: '1',
      ...
      '12878000000375199': {
        ...
        permalink: 'marvelous',
        articleviewtype: 'LISTVIEW',
        child: ['12878000000496149', '12878000000708026', '12878000000496161', '12878000000708023', '12878000000496164', '12878000000708017', '12878000000708020'],
        departmentId: '12878000000365161'
      },
      '12878000000598101': {
        level: '1',
  ...
  result: ['12878000000083106', '12878000000158018', '12878000000173083', '12878000000249929', '12878000000252041', '12878000000375199', '12878000000598101']
};
var subSectionSchema = schema('categories');
var sectionSchema = schema('categories', {
  mapping: {
    child: arrayOf(subSectionSchema)
  },
  entityAssignment: function entityAssignment(obj, entity) {
    obj.articlesCount = obj.child.reduce(function (res, id) {
...
var subCategorySchema = schema('categories', {
  mapping: {
...
var categorySchema = schema('categories', {
  mapping: {
...
describe('normalizr', function () {
  it('category article count', function () {
    normalize(categoriesRes.data, arrayOf(categorySchema)).should.eql(categoriesOutput);
  });
  ...
  it('Simple assignEntity contact normalize', function () {
    normalize({
      ...
      entityAssignment: function entityAssignment(obj) {
        obj['newKey'] = 'vimal';
        delete obj['id'];
        return obj;
      }
  ...
  it('union', function () {
    normalize([{
      ...
      result: [{ id: 'th1', type: 'thread' }, { id: 'co1', type: 'comment' }, { id: 'th1', type: 'thread' }]
    });
  });
  ...
  it('nested contact with tickets normalize', function () {
    normalize({
      id: 'c1',
      name: 'vimal1',
      ticket: [{ id: 't1', subject: 'ticket1' }, { id: 't2', subject: 'ticket2' }]
    }, schema('contacts', { mapping: { ticket: arrayOf(schema('tickets')) } })).should.eql({
      entities: {
        contacts: {
  ...
  it('nested contacts with tickets normalize', function () {
    normalize([{
      ...
      id: 'c2',
      name: 'vimal2',
      ticket: [{ id: 't3', subject: 'ticket3' }, { id: 't4', subject: 'ticket4' }]
    }], arrayOf(schema('contacts', { mapping: { ticket: arrayOf(schema('tickets')) } }))).should.eql({
      entities: {
        contacts: {
          c1: { id: 'c1', name: 'vimal1', ticket: ['t1', 't2'] },
  ...
  it('nested contacts with account normalize', function () {
    ...
    }], arrayOf(schema('contacts', { mapping: { account: schema('accounts') } }))).should.eql({
      entities: {
        contacts: {
  ...
  it('nested stress test ticket contact with account normalize nano second', function () {
    ...
    var a = normalize(ticketObj, schema('ticket', {
      mapping: {
        contact: schema('contacts', {
          mapping: { account: schema('accounts') }
        })
  ...
  it('Simple nested entity not direct key normalize', function () {
    ...
    }, schema('contacts', { mapping: { 'test.account': schema('accounts') } })).should.eql({
      entities: {
        contacts: {
          c1: {
            id: 'c1',
