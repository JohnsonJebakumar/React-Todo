...
export function array(entity, objs, schema) {
  if (Array.isArray(objs)) {
    ...
    var ids = _Object$keys(objs).reduce(function (res, objKey) {
      var id = objKey;
...
export var normalizer = function normalizer(schema) {
  return function (obj) {
    return normalize1(obj, schema);
  };
};

export function normalize1(obj, schema) {
  var entities = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  var level = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;

  if (schema.map) {
    _Object$keys(schema.map).forEach(function (key) {
...
export function schema(entityName) {
...
export function arrayOf(ob) {
  return _Object$assign({}, ob, { group: "array" }); //No I18N
}
export var normalize = function normalize(obj, schema) {
  return normalize1(obj, schema);
};